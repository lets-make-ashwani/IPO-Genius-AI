    ...
    <div className="min-h-screen bg-dark-bg text-text-primary flex flex-col pt-16">
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12">
          ...
          <Link href="/register" className="text-sm font-semibold text-primary-blue hover:underline flex items-center gap-1.5 mt-4 md:mt-0">
          ...
          {mockIPOs.slice(0, 3).map((ipo) => (
            <div key={ipo.id} className="p-6 rounded-lg bg-card-bg border border-border-strong hover:border-secondary-purple/20 transition-all flex flex-col justify-between h-96">
              ...
              <div className="flex items-center justify-between border-t border-border-subtle/40 pt-4 mt-6">
                ...
                <Link href="/register" className="text-xs font-semibold bg-border-subtle hover:bg-border-strong text-white px-3 py-1.5 rounded-md transition-colors">
                  Details →
                </Link>
              </div>
            </div>
